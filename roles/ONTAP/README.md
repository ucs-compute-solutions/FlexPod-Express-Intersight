...
This repository contains Ansible roles and playbooks for an end-to-end ONTAP storage deployment for VMware vSphere 8.0 U3 in a FlexPod Datacenter.
...
These roles are developed as per the best practices prescribed in the NVA "[https://www.netapp.com/pdf.html?item=/media/88340-NVA-FlexpodExpress_C220_A250_NexusFinal.pdf]".

### Environment Validated

As the automation solution is specifically build for the above mentioned NVA, the current roles and playbooks support the following components:

	Storage Operating System: ONTAP 9.12.1
	Storage Protocols: NFS and NVMe
...
The ONTAP setup is split into two sections, use the tags - ontap_config_part_1, ontap_config_part_2 to execute parts of the playbook at the appropriate stage of setup.
...
Execute the playbook from the Ansible Control machine as an admin/ root user using the following command:
	...
	After setup of VMware ESXi		-	ansible-playbook -i hosts Setup_ONTAP.yml -t ontap_config_part_2
